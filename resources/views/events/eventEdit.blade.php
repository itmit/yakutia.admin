...
<form class="form-horizontal" method="POST" action="/events/{{ $id }}" enctype="multipart/form-data">
    {{ method_field('PATCH') }}
    {{ csrf_field() }}
    ...
    <div class="form-group{{ $errors->has('event_head') ? ' has-error' : '' }}">
        ...
        <div class="col-xs-12 col-sm-10">
            <input id="event_head" type="text" class="form-control" name="event_head" value="{{ $event->head }}" required maxlength="191">
    ...
    <div class="row form-group{{ $errors->has('event_body') ? ' has-error' : '' }}">
        ...
        <div class="col-xs-12 col-sm-10">
            <textarea id="event_body" type="text" class="md-textarea form-control" name="event_body" cols="30" rows="10" maxlength="2000">{{ $event->body }}</textarea>
    ...
    <div class="row form-group{{ $errors->has('event_place') ? ' has-error' : '' }}">
        ...
        <div class="col-xs-12 col-sm-10">
            <input type="text" class="form-control" name="event_place" value="{{ $event->place }}" required>
    ...
    <div class="row form-group{{ $errors->has('event_date') ? ' has-error' : '' }}">
        ...
        <div class="col-xs-12 col-sm-10">
            <input type="date" class="form-control" name="event_date" value="{{ date('yyyy-MM-dd', $event->date_start) }}" required>
